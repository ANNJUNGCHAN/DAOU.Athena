...
const INVOKE_CHANNELS = new Set([
  ...
  'athena:backtest-source-map-start',
  'athena:backtest-source-map-status',
  'athena:backtest-source-map-cancel',
  ...
  'athena:project-open',
  'athena:project-tree',
  'athena:project-technique-create',
  'athena:project-terminal',
  'athena:technique-pick-folder',
  'athena:technique-conversation-prepare',
