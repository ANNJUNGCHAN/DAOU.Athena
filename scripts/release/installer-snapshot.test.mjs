...
test("installer snapshots the captured commit despite later commits and working-tree edits", () => {
  ...
  try {
    ...
    const files = ["app/main.js", "app/package-lock.json", "backend/uv.lock", "scripts/windows-installer.config.cjs", "scripts/windows-installer.nsh", "scripts/windows-installer-processes.nsh", "scripts/windows-installer-processes.ps1"];
