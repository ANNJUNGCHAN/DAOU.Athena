    ...
    "properties": {
        ...
        "draft": {
            ...
            "description": (
                ...
                "schedule.once (한 번만 실행 — 시간대 포함 ISO8601 시각, op는 'at') / "
                ...
                "'한 번만' 요청은 반드시 schedule.once를 쓰고 value에 날짜와 시간대까지 "
                "명시한다(예: 2026-09-23T17:07:00+09:00). 반복 예약과 만료로 흉내 내지 않는다. "
                ...
                "main_card_candidate는 이 알람이 울렸을 때 대화창에 "
